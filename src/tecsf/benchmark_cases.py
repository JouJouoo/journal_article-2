...
12 13 8 5 1.03 0.34 200
13 14 8 5.5 1.044 0.345 200
...
36 37 26 18.55 0.064 0.1565 200
...
51 52 3.6 2.7 0.331 0.1114 200
9 53 4.35 3.5 0.174 0.0886 300
...
BENCHMARK_CASES: dict[str, BenchmarkCase] = {
    "ieee33bw": _parse_rows(
        ...
        raw=_IEEE33_ROWS,
        num_buses=33,
        source="MATPOWER/pandapower case33bw, Baran and Wu 1989; mirrored 33/69 text table for local reproducibility.",
    ...
    "ieee69": _parse_rows(
        ...
        raw=_IEEE69_ROWS,
        num_buses=69,
        source="Public IEEE 69-bus radial distribution data table used by 33/69 pandapower examples.",
        source_url="https://github.com/xiaoniumang/pandapower",
